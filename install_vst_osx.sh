...
# Adapted from https://github.com/RustAudio/vst-rs/blob/master/osx_vst_bundler.sh
...
if rm -r "$HOME/Library/Audio/Plug-Ins/VST/$1.vst"; then
  echo "Removed old bundle $1.vst"
else
  echo "No old bundle found."
fi

mv "$1.vst" "$HOME/Library/Audio/Plug-Ins/VST/"
